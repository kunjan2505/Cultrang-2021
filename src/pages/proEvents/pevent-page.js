...
const Event = () => {
    const { id } = useParams();
    var titles = ["COMEDY NIGHT","MELODIOUS AU REVOIR","MUSIC WORKSHOP BY ADIL RASHID","THEATER WORKSHOP BY PRADEEP BAJPAI","HIP HOP WORKSHOP BY KUNAL SRIVASTAVA"]
    var title = titles[0]
    var ticket = ticett1
    var discription = "Comedic performance in front of a live audience on an online platform, by the esteemed satirist, Appurv Gupta. A pro-event involving humorous instances, jokes, one-liners and much more, to entertain the crowd and tickle some funny bones."
    if(id === "melodiousAuRevoir"){
        title = titles[1]
        ticket = ticket2
        discription = "An evening filled with soulful melodies, dedicated to resonant musical performances by a virtuoso coupled with a live performance by a ‘pomedian’ which is sure to drive you nuts! Prepare yourselves to laugh and cry, all at the same time as you join us for this melodious au revoir!"
    }
        ...
        title = titles[3]
        ticket = ticket4
        discription = "Want to be a superstar? Join our virtual workshop on 9th of April to learn and get some tips to boost your acting skills with Actor and Director, Mr Pradeep Bajpai. The webinar is open to all, so set up your acting faces and learn something new and fun. Register for Workshop here"
    }
    else if(id === "hipHopWorkshop"){
        title = titles[4]
        ticket = ticket5
        discription="Yearning to learn and have fun with street dance styles? Join our virtual workshop on 10th April to learn Hip Hop from Dancer and Choreographer, Kunal Srivastava. The workshop is open to all, so put on your dancing shoes and join other dancers like yourself to learn something new and fun. No prerequisites, because Anybody Can Dance!"
    }
            ...
            <div className="event-context">
                ...
                <div className="pevent-mobile">
                    <div className="pevent-tickets-m">
                        <div className="pevent-title" id="big-title">{title}</div>
