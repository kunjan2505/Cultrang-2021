...
function EventPage() {
    ...
    return (
        <div className="event">
            ...
            <img src={cloud1} className="mobileEventVector" style={{ top: '0px', left: '0px', width: '100vw'}}/>            
            <img src={cloud2} className="mobileEventVector"  style={{ top: '0px', right: '0px',  width: '100vw'}}/>
            <img src={bottomRight} className="mobileEventVector" style={{bottom: '0px',marginLeft: '20vw',height: '20vh', }}/>
            {!mobile && 
            ...
            <div className="mobile-event-info">
                ...
                <div className="mobile-event-register">
                    <p  style={{ fontSize: '2em', color: 'white', fontWeight: 'bold' , margin: '10px',  textShadow:' 4px 4px #000000'}}> {event.eventName.toUpperCase()}</p>
                    <div className="mobile-event-poster">    
                        <img src={smallCardCorner}  className="smallCard-corner" />
                        <div className="mobile-posterClass">
                            <img src={event.poster} alt={event.eventNickName} className="mobile-posterImg" objectFit="cover"/>                 
                        </div>                                         
                    </div>
                    ...
                    <div className="register-button" >                        
                        <p style={{ fontSize: '20px', fontWeight: 'bold', margin: '0px' }}>REGISTER</p>                                             
                    </div>
                </div>
            </div>
            }
